...
-- DropForeignKey
ALTER TABLE "avaliacoes" DROP CONSTRAINT "fk_avaliacao_cliente";

-- DropForeignKey
ALTER TABLE "avaliacoes" DROP CONSTRAINT "fk_avaliacao_vendedor";
...
-- DropForeignKey
ALTER TABLE "pedidos" DROP CONSTRAINT "fk_pedido_vendedor";

-- DropForeignKey
ALTER TABLE "produtos" DROP CONSTRAINT "fk_produto_vendedor";
